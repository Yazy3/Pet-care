...
<div class="container-fluid px-0">
    ...
    <div id="welcome-card" class="mb-4" style="
        ...
        <div
            style="position:absolute;top:-40px;right:-40px;width:200px;height:200px;border-radius:50%;background:rgba(255,255,255,0.06);">
        </div>
        <div
            style="position:absolute;bottom:-30px;right:100px;width:120px;height:120px;border-radius:50%;background:rgba(255,255,255,0.05);">
        </div>
        <div
            style="position:absolute;right:32px;top:50%;transform:translateY(-50%);opacity:0.08;font-size:120px;line-height:1;">
            <i class="bi bi-paw-fill"></i>
        </div>

        <div class="d-flex align-items-center gap-3 mb-3">
            <div
                style="width:52px;height:52px;border-radius:14px;background:rgba(255,255,255,0.15);display:grid;place-items:center;font-size:26px;color:#fff;flex-shrink:0;">
                <i class="bi bi-heart-pulse-fill"></i>
            </div>
            <div>
                <div style="color:rgba(255,255,255,0.65);font-size:12px;letter-spacing:.05em;text-transform:uppercase;">
                    PetCare Veterinary Clinic</div>
                <h4 style="color:#fff;font-weight:700;margin:0;">
                    Welcome back,
                    <?= htmlspecialchars($_SESSION['user']['username'] ?? $_SESSION['user']['name'] ?? 'Staff') ?>!
                </h4>
            </div>
        </div>
        <p style="color:rgba(255,255,255,0.72);margin:0;font-size:14px;max-width:500px;">
            You're logged in as <strong style="color:#fff;">Staff</strong>. Use the sidebar to manage owners, pets,
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-lg-3">
            <div class="stat-c">
                ...
                <div>
                    <div class="stat-v" style="color:<?= ($dueSoon ?? 0) > 0 ? '#dc3545' : 'inherit' ?>">
                        <?= $dueSoon ?? 0 ?>
                    </div>
    ...
    <div class="clinic-image-panel" style="min-height: 280px;">
        <img src="https://t4.ftcdn.net/jpg/07/63/82/49/360_F_763824918_0DC9niVcINfJJ3g0JON4iPukdkrNXIq7.jpg"
            alt="Veterinary clinic" onerror="this.style.display='none'">
