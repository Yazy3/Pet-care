            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="?controller=pet&action=show&id=<?= $p['pet_id'] ?? '' ?>" class="btn btn-sm btn-outline-info py-0" title="View"><i class="bi bi-eye"></i></a>
                        <a href="?controller=pet&action=edit&id=<?= $p['pet_id'] ?? '' ?>" class="btn btn-sm btn-outline-warning py-0" title="Edit"><i class="bi bi-pencil"></i></a>
                    </td>
                </tr>
