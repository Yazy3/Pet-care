<?php $pageTitle = 'New Vaccination Record';
require __DIR__ . '/../../layouts/layout.php'; ?>

<div class="row justify-content-center">
    <div class="col-12 col-lg-8">
        <div class="form-card">
            <div class="fc-title"><i class="bi bi-clipboard2-pulse-fill me-2 text-success"></i>Log Vaccination Record
            </div>
            <form method="POST" action="?controller=record&action=store">
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-success"><i class="bi bi-check-lg me-1"></i>Save
                        Record</button>
