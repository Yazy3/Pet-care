<?php $pageTitle = 'Edit Record'; require __DIR__ . '/../../layouts/layout.php'; ?>

<div class="row justify-content-center">
    <div class="col-12 col-lg-8">
        <div class="form-card">
            <div class="fc-title"><i class="bi bi-pencil-square me-2 text-warning"></i>Edit Vaccination Record</div>
            <form method="POST" action="?controller=record&action=update&id=<?= $record['record_id'] ?>">
                <div class="row g-3">
                    <div class="col-md-6">
