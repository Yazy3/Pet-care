...
<body>
    ...
    // ✅ FIXED: Safe session handling to remove warnings
    $user = $_SESSION['user'] ?? [];
    $displayName = !empty($user['username']) ? $user['username'] : 'Pet Owner';
    ?>
    ...
    <nav id="sb">
        ...
        <div class="sb-sec">
            ...
            <ul class="sb-nav">
                ...
                <li><a href="?controller=ownerdashboard&action=index"
                        class="nl <?= isActiveOwner('ownerdashboard', 'index') ?>" onclick="closeSidebar()">
                        <i class="bi bi-paw-fill"></i> My Pets
                    </a></li>

                <li><a href="?controller=ownerdashboard&action=schedule"
                        class="nl <?= isActiveOwner('ownerdashboard', 'schedule') ?>" onclick="closeSidebar()">
        ...
        <div class="sb-foot">
            <div class="sb-usr">
                <div class="sb-av"><?= strtoupper(substr($displayName, 0, 1)) ?></div>
                <div>
                    <div class="sb-un"><?= htmlspecialchars($displayName) ?></div>
